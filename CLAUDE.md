...
- **typecheck** — constraint-satisfaction (`expect_errors`): self-match, raw-cast `::`, composites, carve implicit-constraints, executes, references in `&`/`|`/`~`, patterns, string sequences/negation/tri-range, self-property carve refs (`z->.z{…}`). ~482 pass.
