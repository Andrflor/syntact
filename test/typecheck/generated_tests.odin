...
@(test)
test_tc_carve_impl_dep_compensated_ok_57 :: proc(t: ^testing.T) {
	run_typecheck_test("tests/tc_carve_impl_dep_compensated_ok.json", t)
}

@(test)
test_tc_comparison_envelope_decides_58 :: proc(t: ^testing.T) {
	run_typecheck_test("tests/tc_comparison_envelope_decides.json", t)
}

@(test)
test_tc_eqset_dneg_collapse_bad_59 :: proc(t: ^testing.T) {
	run_typecheck_test("tests/tc_eqset_dneg_collapse_bad.json", t)
}

@(test)
test_tc_pat_nested_ok_60 :: proc(t: ^testing.T) {
...
@(test)
test_tc_eqset_or_id_ok_62 :: proc(t: ^testing.T) {
	run_typecheck_test("tests/tc_eqset_or_id_ok.json", t)
}

@(test)
test_tc_pat_prod_string_ok_63 :: proc(t: ^testing.T) {
	run_typecheck_test("tests/tc_pat_prod_string_ok.json", t)
}

@(test)
test_tc_flt_open_lo_ok_64 :: proc(t: ^testing.T) {
	run_typecheck_test("tests/tc_flt_open_lo_ok.json", t)
}

@(test)
test_tc_pull_named_vs_struct_agree_ok_65 :: proc(t: ^testing.T) {
	run_typecheck_test("tests/tc_pull_named_vs_struct_agree_ok.json", t)
}

@(test)
test_tc_pat_target_arith_nonexh_66 :: proc(t: ^testing.T) {
...
@(test)
test_tc_color_carve_chain_ok_406 :: proc(t: ^testing.T) {
	run_typecheck_test("tests/tc_color_carve_chain_ok.json", t)
}

@(test)
test_tc_carve_override_ref_overflow_bad_407 :: proc(t: ^testing.T) {
