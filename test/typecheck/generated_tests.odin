...
@(test)
test_tc_eqset_dneg_collapse_bad_58 :: proc(t: ^testing.T) {
	run_typecheck_test("tests/tc_eqset_dneg_collapse_bad.json", t)
}

@(test)
test_tc_pat_nested_ok_59 :: proc(t: ^testing.T) {
	run_typecheck_test("tests/tc_pat_nested_ok.json", t)
}

@(test)
test_tc_pos_str_bad_60 :: proc(t: ^testing.T) {
	run_typecheck_test("tests/tc_pos_str_bad.json", t)
}

@(test)
test_tc_eqset_or_id_ok_61 :: proc(t: ^testing.T) {
	run_typecheck_test("tests/tc_eqset_or_id_ok.json", t)
}

@(test)
test_tc_pat_prod_string_ok_62 :: proc(t: ^testing.T) {
	run_typecheck_test("tests/tc_pat_prod_string_ok.json", t)
}

@(test)
test_tc_flt_open_lo_ok_63 :: proc(t: ^testing.T) {
	run_typecheck_test("tests/tc_flt_open_lo_ok.json", t)
}

@(test)
test_tc_pull_named_vs_struct_agree_ok_64 :: proc(t: ^testing.T) {
	run_typecheck_test("tests/tc_pull_named_vs_struct_agree_ok.json", t)
}

@(test)
test_tc_pat_target_arith_nonexh_65 :: proc(t: ^testing.T) {
...
@(test)
test_tc_seq_two_classes_fewletters_bad_115 :: proc(t: ^testing.T) {
	run_typecheck_test("tests/tc_seq_two_classes_fewletters_bad.json", t)
}

@(test)
test_tc_chained_range_ok_116 :: proc(t: ^testing.T) {
	run_typecheck_test("tests/tc_chained_range_ok.json", t)
}

@(test)
test_tc_cast_unknown_sum_overflow_fail_117 :: proc(t: ^testing.T) {
	run_typecheck_test("tests/tc_cast_unknown_sum_overflow_fail.json", t)
}

@(test)
test_tc_infinite_default_118 :: proc(t: ^testing.T) {
	run_typecheck_test("tests/tc_infinite_default.json", t)
}

@(test)
test_tc_execute_carve_as_type_ok_119 :: proc(t: ^testing.T) {
	run_typecheck_test("tests/tc_execute_carve_as_type_ok.json", t)
}

@(test)
test_tc_pat_char_value_ok_120 :: proc(t: ^testing.T) {
	run_typecheck_test("tests/tc_pat_char_value_ok.json", t)
}

@(test)
test_tc_str_ord_above_bad_121 :: proc(t: ^testing.T) {
	run_typecheck_test("tests/tc_str_ord_above_bad.json", t)
}

@(test)
test_tc_cast_u8_to_f32_ok_122 :: proc(t: ^testing.T) {
