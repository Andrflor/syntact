...
@(test)
test_tc_cmp_gt6f_ok_250 :: proc(t: ^testing.T) {
	run_typecheck_test("tests/tc_cmp_gt6f_ok.json", t)
}

@(test)
test_tc_symbolic_compose_ok_251 :: proc(t: ^testing.T) {
	run_typecheck_test("tests/tc_symbolic_compose_ok.json", t)
}

@(test)
test_tc_neg_subset_ok_252 :: proc(t: ^testing.T) {
	run_typecheck_test("tests/tc_neg_subset_ok.json", t)
}

@(test)
test_tc_flt_open_lo_ok_253 :: proc(t: ^testing.T) {
	run_typecheck_test("tests/tc_flt_open_lo_ok.json", t)
}

@(test)
test_tc_union_char_alts_ok_254 :: proc(t: ^testing.T) {
	run_typecheck_test("tests/tc_union_char_alts_ok.json", t)
}

@(test)
test_tc_str_concat_lit_class_prefix_bad_255 :: proc(t: ^testing.T) {
