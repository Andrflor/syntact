...
@(test)
test_invalid_binding_name_scope_0 :: proc(t: ^testing.T) {
	run_analyze_test("tests/invalid_binding_name_scope.json", t)
}

@(test)
test_invalid_constraint_name_integer_1 :: proc(t: ^testing.T) {
	run_analyze_test("tests/invalid_constraint_name_integer.json", t)
}

@(test)
test_typecheck_bool_singleton_fail_2 :: proc(t: ^testing.T) {
	run_analyze_test("tests/typecheck_bool_singleton_fail.json", t)
}

@(test)
test_invalid_property_name_chained_integer_3 :: proc(t: ^testing.T) {
	run_analyze_test("tests/invalid_property_name_chained_integer.json", t)
}

@(test)
test_implicit_carve_valid_both_4 :: proc(t: ^testing.T) {
	run_analyze_test("tests/implicit_carve_valid_both.json", t)
}

@(test)
test_implicit_carve_missing_property_5 :: proc(t: ^testing.T) {
	run_analyze_test("tests/implicit_carve_missing_property.json", t)
}

@(test)
test_implicit_carve_non_scope_6 :: proc(t: ^testing.T) {
...
@(test)
test_constraint_product_constraint_scope_literal_fail_71 :: proc(t: ^testing.T) {
	run_analyze_test("tests/constraint_product_constraint_scope_literal_fail.json", t)
}

@(test)
test_typecheck_u8_valid_zero_72 :: proc(t: ^testing.T) {
	run_analyze_test("tests/typecheck_u8_valid_zero.json", t)
}

@(test)
test_invalid_property_name_string_73 :: proc(t: ^testing.T) {
...
@(test)
test_typecheck_u64_negative_75 :: proc(t: ^testing.T) {
	run_analyze_test("tests/typecheck_u64_negative.json", t)
}

@(test)
test_constraint_scope_in_compound_array_76 :: proc(t: ^testing.T) {
