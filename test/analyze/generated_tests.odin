...
@(test)
test_div_int_by_zero_range_6 :: proc(t: ^testing.T) {
	run_analyze_test("tests/div_int_by_zero_range.json", t)
}

@(test)
test_constraint_product_constraint_carve_fail_7 :: proc(t: ^testing.T) {
	run_analyze_test("tests/constraint_product_constraint_carve_fail.json", t)
}

@(test)
test_scope_add_property_base_8 :: proc(t: ^testing.T) {
	run_analyze_test("tests/scope_add_property_base.json", t)
}

@(test)
test_default_bool_true_first_9 :: proc(t: ^testing.T) {
	run_analyze_test("tests/default_bool_true_first.json", t)
}

@(test)
test_typecheck_u8_string_10 :: proc(t: ^testing.T) {
	run_analyze_test("tests/typecheck_u8_string.json", t)
}

@(test)
test_constraint_product_constraint_vs_value_distinction_11 :: proc(t: ^testing.T) {
	run_analyze_test("tests/constraint_product_constraint_vs_value_distinction.json", t)
}

@(test)
test_typecheck_bool_empty_complement_fail_12 :: proc(t: ^testing.T) {
	run_analyze_test("tests/typecheck_bool_empty_complement_fail.json", t)
}

@(test)
test_constraint_scope_in_string_13 :: proc(t: ^testing.T) {
	run_analyze_test("tests/constraint_scope_in_string.json", t)
}

@(test)
test_typecheck_i32_overflow_14 :: proc(t: ^testing.T) {
	run_analyze_test("tests/typecheck_i32_overflow.json", t)
}

@(test)
test_implicit_carve_missing_ordinal_15 :: proc(t: ^testing.T) {
	run_analyze_test("tests/implicit_carve_missing_ordinal.json", t)
}

@(test)
test_constraint_product_value_structural_wrong_param_fail_16 :: proc(t: ^testing.T) {
	run_analyze_test("tests/constraint_product_value_structural_wrong_param_fail.json", t)
}

@(test)
test_typecheck_char_valid_17 :: proc(t: ^testing.T) {
	run_analyze_test("tests/typecheck_char_valid.json", t)
}

@(test)
test_implicit_carve_numeric_string_18 :: proc(t: ^testing.T) {
	run_analyze_test("tests/implicit_carve_numeric_string.json", t)
}

@(test)
test_typecheck_no_constraint_19 :: proc(t: ^testing.T) {
	run_analyze_test("tests/typecheck_no_constraint.json", t)
}

@(test)
test_constraint_builtin_array_valid_20 :: proc(t: ^testing.T) {
	run_analyze_test("tests/constraint_builtin_array_valid.json", t)
}

@(test)
test_typecheck_u8_bool_21 :: proc(t: ^testing.T) {
	run_analyze_test("tests/typecheck_u8_bool.json", t)
}

@(test)
test_typecheck_bool_string_22 :: proc(t: ^testing.T) {
	run_analyze_test("tests/typecheck_bool_string.json", t)
}

@(test)
test_scope_add_property_override_23 :: proc(t: ^testing.T) {
	run_analyze_test("tests/scope_add_property_override.json", t)
}

@(test)
test_typecheck_string_bool_24 :: proc(t: ^testing.T) {
	run_analyze_test("tests/typecheck_string_bool.json", t)
}

@(test)
test_constraint_product_value_literal_fail_25 :: proc(t: ^testing.T) {
	run_analyze_test("tests/constraint_product_value_literal_fail.json", t)
}

@(test)
test_typecheck_u32_overflow_26 :: proc(t: ^testing.T) {
	run_analyze_test("tests/typecheck_u32_overflow.json", t)
}

@(test)
test_typecheck_i8_overflow_27 :: proc(t: ^testing.T) {
	run_analyze_test("tests/typecheck_i8_overflow.json", t)
}

@(test)
test_typecheck_bool_negate_fail_28 :: proc(t: ^testing.T) {
	run_analyze_test("tests/typecheck_bool_negate_fail.json", t)
}

@(test)
test_typecheck_i64_valid_large_29 :: proc(t: ^testing.T) {
	run_analyze_test("tests/typecheck_i64_valid_large.json", t)
}

@(test)
test_typecheck_bool_negate_valid_30 :: proc(t: ^testing.T) {
	run_analyze_test("tests/typecheck_bool_negate_valid.json", t)
}

@(test)
test_typecheck_u8_scope_31 :: proc(t: ^testing.T) {
	run_analyze_test("tests/typecheck_u8_scope.json", t)
}

@(test)
test_typecheck_constraint_only_32 :: proc(t: ^testing.T) {
	run_analyze_test("tests/typecheck_constraint_only.json", t)
}

@(test)
test_div_float_by_const_33 :: proc(t: ^testing.T) {
	run_analyze_test("tests/div_float_by_const.json", t)
}

@(test)
test_constraint_scope_element_direct_34 :: proc(t: ^testing.T) {
	run_analyze_test("tests/constraint_scope_element_direct.json", t)
}

@(test)
test_typecheck_i16_valid_35 :: proc(t: ^testing.T) {
	run_analyze_test("tests/typecheck_i16_valid.json", t)
}

@(test)
test_typecheck_string_valid_36 :: proc(t: ^testing.T) {
	run_analyze_test("tests/typecheck_string_valid.json", t)
}

@(test)
test_constraint_product_value_carve_pass_37 :: proc(t: ^testing.T) {
	run_analyze_test("tests/constraint_product_value_carve_pass.json", t)
}

@(test)
test_constraint_product_value_carve_wrong_param_fail_38 :: proc(t: ^testing.T) {
	run_analyze_test("tests/constraint_product_value_carve_wrong_param_fail.json", t)
}

@(test)
test_div_float_by_zero_range_ieee_39 :: proc(t: ^testing.T) {
	run_analyze_test("tests/div_float_by_zero_range_ieee.json", t)
}

@(test)
test_typecheck_u8_overflow_40 :: proc(t: ^testing.T) {
	run_analyze_test("tests/typecheck_u8_overflow.json", t)
}

@(test)
test_typecheck_u16_valid_41 :: proc(t: ^testing.T) {
	run_analyze_test("tests/typecheck_u16_valid.json", t)
}

@(test)
test_typecheck_f32_valid_42 :: proc(t: ^testing.T) {
	run_analyze_test("tests/typecheck_f32_valid.json", t)
}

@(test)
test_typecheck_bool_valid_true_43 :: proc(t: ^testing.T) {
	run_analyze_test("tests/typecheck_bool_valid_true.json", t)
}

@(test)
test_typecheck_u16_overflow_44 :: proc(t: ^testing.T) {
	run_analyze_test("tests/typecheck_u16_overflow.json", t)
}

@(test)
test_constraint_int_in_compound_array_45 :: proc(t: ^testing.T) {
	run_analyze_test("tests/constraint_int_in_compound_array.json", t)
}

@(test)
test_div_int_by_safe_const_46 :: proc(t: ^testing.T) {
	run_analyze_test("tests/div_int_by_safe_const.json", t)
}

@(test)
test_constraint_product_constraint_mixed_fail_47 :: proc(t: ^testing.T) {
	run_analyze_test("tests/constraint_product_constraint_mixed_fail.json", t)
}

@(test)
test_default_bool_only_48 :: proc(t: ^testing.T) {
	run_analyze_test("tests/default_bool_only.json", t)
}

@(test)
test_typecheck_string_int_49 :: proc(t: ^testing.T) {
	run_analyze_test("tests/typecheck_string_int.json", t)
}

@(test)
test_typecheck_f64_valid_50 :: proc(t: ^testing.T) {
	run_analyze_test("tests/typecheck_f64_valid.json", t)
}

@(test)
test_constraint_product_constraint_scope_literal_pass_51 :: proc(t: ^testing.T) {
	run_analyze_test("tests/constraint_product_constraint_scope_literal_pass.json", t)
}

@(test)
test_typecheck_i8_valid_max_52 :: proc(t: ^testing.T) {
	run_analyze_test("tests/typecheck_i8_valid_max.json", t)
}

@(test)
test_typecheck_u8_float_53 :: proc(t: ^testing.T) {
	run_analyze_test("tests/typecheck_u8_float.json", t)
}

@(test)
test_constraint_scope_in_builtin_array_54 :: proc(t: ^testing.T) {
	run_analyze_test("tests/constraint_scope_in_builtin_array.json", t)
}

@(test)
test_typecheck_bool_valid_false_55 :: proc(t: ^testing.T) {
	run_analyze_test("tests/typecheck_bool_valid_false.json", t)
}

@(test)
test_constraint_product_simple_constraint_pass_56 :: proc(t: ^testing.T) {
	run_analyze_test("tests/constraint_product_simple_constraint_pass.json", t)
}

@(test)
test_typecheck_char_overflow_57 :: proc(t: ^testing.T) {
	run_analyze_test("tests/typecheck_char_overflow.json", t)
}

@(test)
test_constraint_product_simple_constraint_fail_58 :: proc(t: ^testing.T) {
	run_analyze_test("tests/constraint_product_simple_constraint_fail.json", t)
}

@(test)
test_typecheck_u32_valid_59 :: proc(t: ^testing.T) {
