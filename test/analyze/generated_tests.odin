...
@(test)
test_typecheck_u8_valid_max_25 :: proc(t: ^testing.T) {
	run_analyze_test("tests/typecheck_u8_valid_max.json", t)
}

@(test)
test_typecheck_u16_overflow_26 :: proc(t: ^testing.T) {
	run_analyze_test("tests/typecheck_u16_overflow.json", t)
}

@(test)
test_constraint_builtin_array_valid_27 :: proc(t: ^testing.T) {
	run_analyze_test("tests/constraint_builtin_array_valid.json", t)
}

@(test)
test_invalid_binding_name_scope_28 :: proc(t: ^testing.T) {
	run_analyze_test("tests/invalid_binding_name_scope.json", t)
}

@(test)
test_typecheck_i8_overflow_29 :: proc(t: ^testing.T) {
